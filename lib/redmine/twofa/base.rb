module Redmine
  module Twofa
    class Base
      ...
      def custom_security_notification(user, message)
        if Redmine::VERSION::MAJOR == 4
          Mailer.security_notification(user, User.current, message)
        else
          Mailer.security_notification(user, message)
        end
      end
